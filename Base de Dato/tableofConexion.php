...
$productos = [
    ...
    ['Plato Hehua', NULL, NULL, 'Plato Hehua', 5.00, 'El plato "Hehua" es una pieza elegante y artística, diseñada para añadir un toque de sofisticación y belleza a cualquier mesa. Inspirado en la delicadeza y la belleza de las flores de loto, este plato es perfecto tanto para el uso diario como para ocasiones especiales, convirtiendo cada comida en una experiencia visualmente agradable.', 'Dimensiones: El plato tiene un diámetro estándar de aproximadamente 27 cm, proporcionando un tamaño ideal para servir una variedad de alimentos, desde aperitivos hasta platos principales.', '35.png', 10, NULL,NULL, NULL, NULL, NULL, 3, null],
